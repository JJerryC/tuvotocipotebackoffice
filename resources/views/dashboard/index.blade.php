...
@push('css')
    ...
    <style>
        ...
        :root {
            ...
            --text-secondary: #4b5563; /* texto secundario gris */
    ...
    <style>
        /* --- Fondo claro para el área de contenido central --- */
        .content-wrapper,
        .content,
        .dashboard-container {
            background: var(--dark-gradient);
...
const labelsGenero = generoData.map(g => `${g.genero} (${g.total})`);
    ...
    options: {
        ...
        scales: {
            ...
            x: {
                ticks: {
                    ...
                    callback: function(value, index) {
                        const data = [estadisticas.perfiles_completos ?? 0, estadisticas.perfiles_incompletos ?? 0];
            ...
            new Chart(document.getElementById('departamentoChart'), {
                type:'line',
                data:{
                    labels: depData.map(d => d.departamento || 'Sin datos'),
                    datasets:[{
                        label:'Candidatos',
                ...
                options:{
                    responsive:true,
                    plugins:{
                        legend:{labels:{color:'#1f2937'}}  // texto oscuro leyenda
                    },
                    scales:{
                        y:{ticks:{color:'#1f2937'}},  // texto oscuro eje Y
                        x:{ticks:{color:'#1f2937'}}   // texto oscuro eje X
                    }
                }
            });
