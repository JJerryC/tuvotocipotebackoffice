...
<div class="candidate-show-container">
    <div class="candidate-header">
        <img src="{{ asset('storage/fotos/' . $candidate->fotografia) }}" alt="Foto del candidato" class="candidate-photo">
    ...
    <div class="candidate-propuestas">
        ...
        <p>{{ $candidate->propuestas ?? 'Sin propuestas registradas.' }}</p>
    </div>

    <a href="{{ route('dashboard.candidatos') }}" class="back-button"><i class="fas fa-arrow-left mr-1"></i> Volver</a>
</div>
@endsection